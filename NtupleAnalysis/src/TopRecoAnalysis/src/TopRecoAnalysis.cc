  ...
  for(AK8Jet fatJet: fEvent.ak8jets())
    {
      ...
      double tau_21 = fatJet.NjettinessAK8CHSTau2()/fatJet.NjettinessAK8CHSTau1();
      if (tau_21 > 0.6) continue;
      if (fatJet.SoftDropMass() < 65 || fatJet.SoftDropMass() > 105) continue;
  ...
  for(AK8Jet fatJet: fEvent.ak8jets())
    {
      ...
      bool passSDmass = fatJet.SoftDropMass() >= 65 && fatJet.SoftDropMass() <= 105;
